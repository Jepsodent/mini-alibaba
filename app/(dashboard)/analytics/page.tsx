    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[80vh] p-8 text-center space-y-4">
        ...
        <h2 className="text-3xl font-bold text-foreground">
          Belum ada Merchant yang Dianalisis
        </h2>
        <p className="text-muted-foreground max-w-md text-sm">
          Sistem belum mendeteksi merchant yang sedang Anda pantau. Silakan buka
          halaman Merchant Exposure dan pilih salah satu merchant untuk melihat
          analitik dan sinyal risiko detailnya.
        </p>
        <Link href="/exposure">
